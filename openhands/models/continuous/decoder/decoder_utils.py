...
from .transformer_decoder import TransformerDecoder, Embeddings
...
def transformer_greedy(
    ...
    for _ in range(max_output_length):
        ...
        trg_embed = ys  # embed the previous tokens
...
def ctc_decode(
    ...
    ctc_decode, _ = tf.nn.ctc_beam_search_decoder(
        ...
        sequence_length=frame_lengths.cpu().detach().numpy(),
